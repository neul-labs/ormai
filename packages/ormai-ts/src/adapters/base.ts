  ...
  implements OrmAdapter<DB, CompiledT, MutationT>
{
  ...
  compileCreate(
    ...
    throw new Error('Create not implemented for this adapter');
  }
  ...
  compileDelete(
    ...
    throw new Error('Delete not implemented for this adapter');
  }
  ...
  compileBulkUpdate(
    ...
    throw new Error('Bulk update not implemented for this adapter');
  }
